...
var Router = function () {
  function Router() {
    ...
    this.setDefaultPage = function (page, params) {
      if (params === void 0) {
        params = null;
      }
    ...
    this.addRoutePath = function (path, page, params) {
      if (params === void 0) {
        params = null;
      }
      ...
      if (!_this.isStart) {
        _this.isStart = true;
        setTimeout(_this.route.bind(_this), 0);
      }
    ...
    this.route = function () {
      ...
      for (var _i = 0, _a = _this.routeTable; _i < _a.length; _i++) {
        var routeInfo = _a[_i];
...
var View = function () {
  function View(containerId, template) {
    ...
    this.setTemplateData = function (key, value) {
      _this.renderTemplate = _this.renderTemplate.replace("{{__" + key + "__}}", value);
      return;
    };
...
var NewsFeedApi = function (_super) {
  ...
  function NewsFeedApi() {
    var _this = _super.call(this, config_1.NEWS_URL) || this;
    /*
...
var NewsDetailApi = function (_super) {
  ...
  function NewsDetailApi(id) {
    var _this = _super.call(this, config_1.CONTENT_URL.replace("@id", id)) || this;
    /*
...
},{"../config":"src/config.ts"}],"src/page/news-feed-view.ts":[function(require,module,exports) {
"use strict";
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              ...
              , 2];
              /*
              this.api.getDataWithXHR((feeds: NewsFeed[]) => {
...
},{"../core/view":"src/core/view.ts","../core/api":"src/core/api.ts"}],"src/page/news-detail-view.ts":[function(require,module,exports) {
"use strict";
...
},{"./core/router":"src/core/router.ts","./page":"src/page/index.ts","./store":"src/store.ts"}],"C:/Users/drago/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5972" + '/');
...
},{}]},{},["C:/Users/drago/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/app.ts"], null)
